...
select ID2 as ID, count(*) as COUNT from friends group by ID2 having count(*) > 1 union select ID1 as ID, count(*) as COUNT from friends group by ID1  having count(*) > 1
 */
}
